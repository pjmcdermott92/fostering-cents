...
export interface Form {
  ...
  emails?:
    ...
    | null;
  /**
   * Attached to submit button to track clicks
   */
  customId?: string | null;
  /**
   * Require user to answer CAPTCHA question before submitting form
   */
  useCaptcha?: boolean | null;
  updatedAt: string;
  createdAt: string;
}
/**
...
export interface BannerBlock {
  type: 'primary' | 'success' | 'warning' | 'error' | 'heart';
